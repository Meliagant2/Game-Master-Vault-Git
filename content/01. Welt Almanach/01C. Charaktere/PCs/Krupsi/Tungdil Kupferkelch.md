...
tags:
  - "#Charakter"
  - "#SpielerPC"
image: 98. Diverses/Bilder/Spielercharaktere/Tungdil Kupferkelch 1.png
status: ⏳
image2: 98. Diverses/Bilder/Spielercharaktere/Tungdil Kupferkelch 2.png
image3: 98. Diverses/Bilder/Spielercharaktere/Tungdil Kupferkelch x.png
kreaturentyp:
  - Humanoid
aussprache: tunng-diil
spieler: Krupsi
aliase: Kupfer, Silberkelch
...
>>
>> `VIEW[!\[\[{image2}\]\]][text(renderMarkdown)]`
>>
>> `VIEW[!\[\[{image3}\]\]][text(renderMarkdown)]`
>
>``` meta-bind
>INPUT[select(
>option(1, Bio),
