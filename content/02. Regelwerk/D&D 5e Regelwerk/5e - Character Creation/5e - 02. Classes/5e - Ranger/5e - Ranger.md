...
- Gain all the traits in the Core 5e - Ranger Traits table.
- Gain the 5e - Ranger’s level 1 features, which are listed in the 5e - Ranger Features table.

#### As a Multiclass Character

- Gain the following traits from the Core 5e - Ranger Traits table: Hit Point Die,
- Gain the 5e - Ranger’s level 1 features, which are listed in the 5e - Ranger Features table. See the multiclassing rules to determine your available spell slots.
...
### Level 3: 5e - Ranger Subclass

You choose one 5e - Ranger Subclass, which represents you best.

Your 5e - Ranger Subclass grants you features at 3rd, 6th, 9th, 13th, and again at 17th level.
