...
| Level | PB  |    HP    | Hit Die | Ability Increase | Bardic Die | Features                                                           |
| :---: | :-: | :------: | :-----: | :--------------: | :--------: | :----------------------------------------------------------------- |
|  1st  | +2  | 8 + CON  |  +1d8   |                  |     d6     | Jack of all Trades, Bardic Inspiration, Bardic Performance         |
...
|  5th  | +3  | +5 + CON |  +1d8   |                  |     d8     | Countercharm, Font of Inspiration                                  |
...
|  9th  | +4  | +5 + CON |  +1d8   |                  |    d10     | Magical Secrets                                                    |
...
| 13th  | +5  | +5 + CON |  +1d8   |                  |    d12     | Superior Inspiration                                               |
...
| 17th  | +6  | +5 + CON |  +1d8   |                  |    d12     | Virtuoso                                                           |
| 18th  | +6  | +5 + CON |  +1d8   |                  |    d12     | Class Feat, General Feat, Skill Feat                               |
| 19th  | +6  | +5 + CON |  +1d8   |                  |    d12     | Archetype Feature                                                  |
| 20th  | +6  | +5 + CON |  +1d8   |   +1 (max +6)    |    d12     | Words of Creation, Epic Boon, Class Feat, General Feat, Skill Feat |
...
### Level 13: Superior Inspiration

When you roll [[02. Regelwerk/D&D 5e Regelwerk/5e - Combat/5e - Initiative|🎲Initiative]], you regain <u>three</u> expended uses of your **Bardic Inspiration**.

Also, instead of giving a creature a normal **Bardic Inspiration die**, you can spend `2` uses of your **Bardic Inspiration**, to give the creature a `d20` instead.
