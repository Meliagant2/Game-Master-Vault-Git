...
- Gain all the traits in the Core 5e - Paladin Traits table.
- Gain the 5e - Paladin’s level 1 features, which are listed in the 5e - Paladin Features table.

#### As a Multiclass Character

- Gain the following traits from the Core 5e - Paladin Traits table: Hit Point Die,
- Gain the 5e - Paladin’s level 1 features, which are listed in the 5e - Paladin Features table. See the multiclassing rules to determine your available spell slots.
...
You choose one 🦸‍♀️5e - Paladin🦸‍♀️ Subclass, which represents you best.
