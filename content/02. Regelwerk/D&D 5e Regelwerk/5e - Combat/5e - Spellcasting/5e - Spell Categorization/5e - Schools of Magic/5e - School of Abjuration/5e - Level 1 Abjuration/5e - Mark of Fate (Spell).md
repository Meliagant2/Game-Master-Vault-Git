...
dateitags:
  ...
  - "#5e"
status: ✅
reactionbedingung: (You, or a Creature in range is subjected to an effect that forces it to make a Save)
c: " "
school: Abjuration
level: 1
time: R
range-Area: 30 ft.
komponenten: V, S, M (an iron ring)
dauer: Instantaneous
effect:
  - ADV
  - Buff
...
> |**School:**|Abjuration |
> |**Level:**|1 |
> |**Casting Time:**|R (You, or a Creature in range is subjected to an effect that forces it to make a Save)|
> |**Range/Area:**|30 ft. |
...
**<u>Using a Higher-Level Spell Slot:</u>** This spell's bonus to [[02. Regelwerk/D&D 5e Regelwerk/5e - Basic Rules/5e - D20 Tests/5e - Saving Throw/5e - Saving Throw|🎲Saves]] increases by `1` for every spell slot level above 1st.
