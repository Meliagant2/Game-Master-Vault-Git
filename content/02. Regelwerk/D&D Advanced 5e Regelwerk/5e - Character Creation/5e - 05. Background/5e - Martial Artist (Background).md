...
modified: 2026-07-21T13:45:59.321+02:00
published: 2026-07-21T13:45:59.321+02:00
tags:
  - "#Background"
  - "#5e"
dateitags:
...
> > |**Ability Score Increase**|`INPUT[inlineListSuggester(option(STR), option(DEX), option(CON), option(INT), option(WIS), option(CHA)):primeability]`|
