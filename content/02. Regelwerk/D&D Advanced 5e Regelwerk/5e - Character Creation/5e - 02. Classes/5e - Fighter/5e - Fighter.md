...
- Gain all the traits in the Core 5e - Fighter Traits table.
- Gain the 5e - Fighter’s level 1 features, which are listed in the 5e - Fighter Features table.

#### As a Multiclass Character

- Gain the following traits from the Core 5e - Fighter Traits table: Hit Point Die,
- Gain the 5e - Fighter’s level 1 features, which are listed in the 5e - Fighter Features table. See the multiclassing rules to determine your available spell slots.
