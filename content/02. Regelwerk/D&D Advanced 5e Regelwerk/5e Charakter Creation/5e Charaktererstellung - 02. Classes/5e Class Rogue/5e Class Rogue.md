...
- Gain all the traits in the Core 5e Class Rogue Traits table.
- Gain the 5e Class Rogue’s level 1 features, which are listed in the 5e Class Rogue Features table.

#### As a Multiclass Character

- Gain the following traits from the Core 5e Class Rogue Traits table: Hit Point Die,
- Gain the 5e Class Rogue’s level 1 features, which are listed in the 5e Class Rogue Features table. See the multiclassing rules to determine your available spell slots.
...
### Level 3: 5e Class Rogue Subclass

You choose one 5e Class Rogue Subclass, which represents you best.
...
### Level 6: 5e Class Rogue Subclass
...
### Level 9: 5e Class Rogue Subclass
...
### Level 13: 5e Class Rogue Subclass
...
### Level 17: 5e Class Rogue Subclass
