...
- Gain all the traits in the Core `=this.file.name` Traits table.
- Gain the `=this.file.name`’s level 1 features, which are listed in the `=this.file.name` Features table.

#### As a Multiclass Character 
- Gain the following traits from the Core `=this.file.name` Traits table: Hit Point Die
- Gain the `=this.file.name`’s level 1 features, which are listed in the `=this.file.name` Features table. See the multiclassing rules to determine your available spell slots.
...
### Level 3: `=this.file.name` Subclass
You choose one `=this.file.name` Subclass, which represents you best. 

Your `=this.file.name` Subclass grants you features at 3rd, 6th, 9th, 13th, and again at 17th level.
...
>FROM "02. Regelwerk"
>WHERE contains(tags, "#SubClass") AND contains(tags, "#5e")
> SORT file.name ASC
>```
...
### Level 6: `=this.file.name` Subclass
Your `=this.file.name` Subclass grants you features at 3rd, 6th, 9th, 13th, and again at 17th level.
...
### Level 9: `=this.file.name` Subclass
Your `=this.file.name` Subclass grants you features at 3rd, 6th, 9th, 13th, and again at 17th level.
...
### Level 13: `=this.file.name` Subclass
Your `=this.file.name` Subclass grants you features at 3rd, 6th, 9th, 13th, and again at 17th level.
...
### Level 17: `=this.file.name` Subclass
Your `=this.file.name` Subclass grants you features at 3rd, 6th, 9th, 13th, and again at 17th level.
